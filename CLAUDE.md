...
2. M1 is nearly done: F-1.1 through F-1.5, F-2.1 through F-2.6, F-3.1 through F-3.8, F-7.2, and the F-7.3 shell are done. Remaining for M1: `/feature F-7.5` (Settings dialog, Ctrl+,: the Editor tab hosts the formatting controls with a live preview and replaces the toolbar's Formatting popover; the AI tab arrives with F-5.1). Then M2 begins with F-4.1 (tag bank). v0 import was split out as F-1.6 (post-launch).
