...
2. M1 is complete: F-1.1 through F-1.5, F-2.1 through F-2.6, F-3.1 through F-3.8, F-7.2, the F-7.3 shell, and the F-7.5 Editor tab are done (F-7.3 and F-7.5 stay unticked until their remaining tabs land with F-4.2/F-9.x–F-11.x and F-5.1). Next: M2 begins with `/feature F-4.1` (tag bank). v0 import was split out as F-1.6 (post-launch).
