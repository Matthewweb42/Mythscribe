...
2. Next: F-14.9 story bible as ground truth (read `PLAN.md` §2.4 first; it needs F-5.6 summaries, so decide whether F-5.6 comes first), then M3 Story Intelligence (F-5.6 summaries first; F-14.11 beta reader rides on them). F-5.13 (job queue) stays queued. Read `PLAN.md` §2 and §3 before anything under §2.14.
