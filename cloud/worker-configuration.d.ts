/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloud/wrangler.toml cloud/worker-configuration.d.ts` (hash: cede1d87bc0ef4f9a88d28d490eea64f)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_TRANSPORT">> {}
}
