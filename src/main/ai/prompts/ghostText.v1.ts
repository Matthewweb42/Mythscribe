...
/**
 * The ghost-text continuation prompt (F-5.3), version 1. Prompt files are versioned (F-5.12):
 * a change to the text, the caps, or the message order is a new file (`ghostText.v2.ts`) with
 ...
 */
export const GHOST_PROMPT_VERSION = 'ghostText.v1'
